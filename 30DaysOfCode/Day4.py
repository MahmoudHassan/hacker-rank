...
If your methods are implemented correctly, each test case will print 2 or 3 lines (depending on whether or not a valid initailAge was passed to the constructor).
